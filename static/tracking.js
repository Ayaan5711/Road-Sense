    ...
    trafficPanel.innerHTML = data.zones.map(zone => `
        <div class="zone-card">
            ...
            <div class="zone-stats">
                ...
                <p>Density Level: <span class="density-${zone.density_level.toLowerCase()}">${zone.density_level}</span></p>
            ...
            <div class="vehicle-breakdown">
                ...
                <div class="breakdown-grid">
                    ...
                    <div>Two-wheelers: ${zone.vehicle_breakdown.two_wheelers}</div>
                </div>
            </div>
        </div>
    `).join('');
...
async function updateAlertPanel() {
    ...
    alertPanel.innerHTML = `
        ...
        <div class="alert-section">
            ...
            ${data.stopped_vehicles.map(vehicle => `
                <div class="alert-item">
        ...
        <div class="alert-section">
            ...
            ${data.proximity_alerts.map(alert => `
                <div class="alert-item">
        ...
        <div class="alert-section">
            ...
            ${data.accidents.map(accident => `
                <div class="alert-item accident">
                    <p>Accident in ${accident.zone} involving vehicles ${accident.vehicles.join(', ')}</p>
...
async function updateAccidentPanel() {
    ...
    accidentPanel.innerHTML = data.accidents.map(accident => `
...
async function updateAnalyticsPanel() {
    ...
    vehicleCountContainer.innerHTML = '<h3 class="chart-title">Vehicle Count Over Time</h3>';
    ...
    typeContainer.innerHTML = '<h3 class="chart-title">Vehicle Type Distribution</h3>';
    ...
    new Chart(typeCanvas, {
        ...
        data: {
            ...
            datasets: [{
                data: data.vehicle_type_distribution.data.map(arr => arr.reduce((a, b) => a + b, 0)),
                backgroundColor: [
                    'rgba(59, 130, 246, 0.8)',
                    'rgba(16, 185, 129, 0.8)',
                    'rgba(245, 158, 11, 0.8)',
    ...
    congestionContainer.innerHTML = '<h3 class="chart-title">Zone Congestion Levels</h3>';
